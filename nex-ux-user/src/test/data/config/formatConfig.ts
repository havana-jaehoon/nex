...
const adminFolderFormat: NexFormatNode = {
  name: "folder",
  dispName: "폴더",
      ...
      features: [
        {
          ...
          type: NexNodeType.FEATURE,
          isKey: false,
          featureType: NexFeatureType.STRING, // 웹 섹션 타입은 문자열로 처리
        },
        {
          name: "project",
          dispName: "프로젝트",
...
export const adminFormatConfig: NexNode[] = [
  // project Group
  adminProjectFormat,
  adminFormatFormat,
  adminStoreFormat,
  ...
  // CSV-like array: [ name, dispName, description, icon, color]
  {
    ...
    features: [
      ...
      },
      {
        ...
        type: NexNodeType.FEATURE,
        isKey: true,
        featureType: NexFeatureType.STRING, // 테마 이름은 문자열로 처리
      },
      {
        name: "dispName",
        dispName: "테마 출력 이름",
  ...
  // CSV-like array: [ themeName, name, dispName, description, icon, color ]
  {
    ...
    features: [
      ...
      },
      {
        ...
        type: NexNodeType.FEATURE,
        isKey: true,
        featureType: NexFeatureType.STRING, // 카테고리 이름은 문자열로 처리
      },
      {
        name: "dispName",
        dispName: "카테고리 출력 이름",
  ...
  // CSV-like array: [ themeName, themeCategory, name, dispName, description, value ]
  {
    ...
    features: [
      ...
      },
      {
        ...
        type: NexNodeType.FEATURE,
        isKey: false,
        featureType: NexFeatureType.STRING, // 값은 문자열로 처리
      },
    ],
  },
  ...
  // CSV-like array: [ themeName, userId, dispName, description, fontLevel, icon, color ]
  {
    ...
    features: [
      ...
      },
      {
        ...
        type: NexNodeType.FEATURE,
        isKey: true,
        featureType: NexFeatureType.STRING, // 사용자 ID는 문자열로 처리
      },
      {
        name: "dispName",
        dispName: "사용자 출력 이름",
    ...
    features: [
      {
        ...
        type: NexNodeType.FEATURE,
        isKey: false,
        featureType: NexFeatureType.STRING, // 애플릿 타입은 문자열로 처리
      },
      {
        name: "project",
        dispName: "프로젝트",
      ...
      },
      {
        ...
        type: NexNodeType.FEATURE,
        isKey: true,
        featureType: NexFeatureType.STRING, // 애플릿 경로는 문자열로 처리
      },
      {
        name: "name",
        dispName: "애플릿 이름",
        ...
        type: NexNodeType.FEATURE,
        isKey: true,
        featureType: NexFeatureType.STRING, // 애플릿 이름은 문자열로 처리
      },
      {
        name: "dispName",
        dispName: "애플릿 출력 이름",
        ...
        type: NexNodeType.FEATURE,
        isKey: false,
        featureType: NexFeatureType.STRING, // 애플릿 출력 이름은 문자열로 처리
      },
      {
        name: "description",
        dispName: "설명",
        ...
        type: NexNodeType.FEATURE,
        isKey: false,
        featureType: NexFeatureType.STRING, // 애플릿 설명은 문자열로 처리
      },
      {
        name: "icon",
        dispName: "아이콘",
